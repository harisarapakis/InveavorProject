...
namespace CoreInde.Controllers
{
    public class Employees1Controller : Controller
    {
        ...
        {
            var applicationDbContext = _context.Employees.Include(e => e.Skills);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FistName,LastName,HiringDate,SkillsId")] Employees employees)
        {
            if (id != employees.Id)
            {
                return NotFound();
